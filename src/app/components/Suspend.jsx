...
THEIR ACCOUNT WILL BE INACCESSIBLE TO THEM
DURING A SUSPENSION. PROCEED?</p></div>
       ...
       <div className="flex justify-center mt-6">
                    ...
                    <button className="text-[#1E233E] bg-[#F2994A]  py-2 px-4 rounded-md">Suspend driver</button>
